...
parser.add_argument('log_path', help='the path of file recorded the log info', type=str)
...
img_dir = '/Users/phantom/pythonDir/deepxplore/MNIST/seeds'
temp_img_paths = os.listdir(img_dir)
img_paths = [os.path.join('/Users/phantom/pythonDir/deepxplore/MNIST/seeds', img) for img in temp_img_paths]


star_time = time.clock()
# the total number of adversial inputs
adversial_num = 0
...
for img_path in img_paths:
    counter = counter + 1
    print("start testing " + img_path)
    log_str = log_str + img_path + '\n'
    ...
    if not label1 == label2 == label3:
        ...
        adversial_num = adversial_num + 1

        log_str = log_str + "model1-covered neurons percentage:" + str(neuron_covered(model_layer_dict1)[2]) + \
                  ";model2-covered neurons percentage:" + str(neuron_covered(model_layer_dict2)[2]) + \
                  ";model3-covered neurons percentage:" + str(neuron_covered(model_layer_dict3)[2]) + '\n'
        ...
        log_str = log_str + str(counter) + ":averaged covered neurons:" + str(averaged_nc) + '\n'
...
# calculate the average final NC
averaged_nc = (neuron_covered(model_layer_dict1)[0] + neuron_covered(model_layer_dict2)[0] +
                           neuron_covered(model_layer_dict3)[0]) / float(
                neuron_covered(model_layer_dict1)[1] + neuron_covered(model_layer_dict2)[1] +
                neuron_covered(model_layer_dict3)[1])

log_str = log_str + "finally averaged covered neurons:" + str(averaged_nc) + '\n'

end_time = time.clock()
total_time = end_time - star_time
log_str = log_str + "total_num_adversial:" + str(adversial_num) + '\n' + "total_time:" + str(total_time) + '\n'
